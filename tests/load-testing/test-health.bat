...
set "OUTPUT_FILE=%RESULTS_DIR%\health_%TIMESTAMP%.txt"

call :run_ab "Health - tai nhe" 100 10 "%BASE_URL%/health"
call :run_ab "Health - tai trung binh" 500 50 "%BASE_URL%/health"
call :run_ab "Health - tai nang" 1000 100 "%BASE_URL%/health"
